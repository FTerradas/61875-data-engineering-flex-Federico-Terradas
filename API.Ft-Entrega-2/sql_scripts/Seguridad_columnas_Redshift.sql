...
GRANT ALL ON SCHEMA federico_terradas_coderhouse TO data_scientist;
GRANT SELECT(city, temperature, humidity, pressure, weather, wind_speed, timestamp) ON federico_terradas_coderhouse.weather_data TO data_scientist;
...
FROM federico_terradas_coderhouse.weather_data;
